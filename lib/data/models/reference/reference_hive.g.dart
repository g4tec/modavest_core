...
part of 'reference_hive.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class HiveReferenceAdapter extends TypeAdapter<HiveReference> {
  @override
  final int typeId = 8;

  @override
  HiveReference read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, HiveReference obj) {
    writer
      ..writeByte(25)
      ..writeByte(0)
      ..write(obj.code)
