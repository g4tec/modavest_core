...
class _InvoicesCardState extends State<InvoicesCard> {
  ...
  Future<void> _viewDanfe(int index, String accessKey) async {
    setState(() => _loadingView[index] = true);
    try {
      final File file = await _downloadDanfe(accessKey);
  ...
  Future<void> _shareDanfe(int index, String accessKey) async {
                        ...
                        Expanded(
                          child: TextButton.icon(
                            onPressed: _loadingView[index] == true
                                ? null
                                : () => _viewDanfe(index, invoice.accessKey!),
                        ...
                        Expanded(
                          child: TextButton.icon(
                            onPressed: _loadingShare[index] == true
                                ? null
                                : () => _shareDanfe(index, invoice.accessKey!),
